...
namespace Chunyu   // own namespace Chunyu
{
	...
	namespace CAD
	{
		...
		Circle::Circle(const Circle& circle) : Shape(circle), centrePoint(circle.centrePoint), m_radius(circle.m_radius)
		{
		...
		//override Draw() from Shape class in Circle class
		void Circle::Draw() const
		{
			std::cout << "Draw circles" << std::endl;
			std::cout << (*this) << "\n" << std::endl; //print circle description 
		}
