...
int main()
{
	...
	/*
	* Before changing the distance function by reference, 
	* I see 3 times contructors are called include one copy constructor is called and 3 times destructor called
	*
	* After change the distance function by reference,  I see 2 times contructors are called,no copy constructor is called and 2 times destructor called,
	* 
	* I cannot change the input point in the Distance function
	*
	*/
