...
*
* Apply the colon syntax for the Point class constructors
*
* @file Point.cpp
* @author Chunyu Yuan
* @version 1.12 02/13/2021
*
*/
...
namespace Chunyu
{
	...
	namespace CAD
	{
		...
		Point::Point(double xyval) : m_x(xyval), m_y(xyval)				//constructor with one double value, set both x and y to this value
		{	}
