/*
* Level_1 Exercise 1.4.7: program to count how many times each of the numbers 0-4 or other characters 
* have been typed. Extend the program of exercise 1.4.6 in such a way that the frequency of number 3 is shown
* in words.
*
* @file freqV2.c
* @author Chunyu Yuan
