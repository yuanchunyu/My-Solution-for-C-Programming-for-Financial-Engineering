...
namespace Chunyu   // own namespace Chunyu
{
	...
	namespace CAD
	{
		...
		Line::Line(const Point& newStartP, const Point& newEndP) : startPoint(newStartP), endPoint(newEndP) // Colon syntax!
		{
		...
		//copy constructor
		Line::Line(const Line& line):startPoint(line.startPoint), endPoint(line.endPoint) // Colon syntax!
		{
