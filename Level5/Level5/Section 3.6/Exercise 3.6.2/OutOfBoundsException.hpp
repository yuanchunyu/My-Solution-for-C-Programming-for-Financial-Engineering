...
*
* derived from ArrayException base class and implement OutOfBoundsException class
*
...
public :
	...
	OutOfBoundsException() :err_index(-1)// Colon syntax
	{

	}

	//constructor with argument that error index is new_err
	OutOfBoundsException(int new_err) :err_index(new_err) // Colon syntax
	{

	}

	//copy constructor, copy error index of new_exc 
	OutOfBoundsException(const OutOfBoundsException& new_exc) :err_index(new_exc.err_index) // Colon syntax
	{
