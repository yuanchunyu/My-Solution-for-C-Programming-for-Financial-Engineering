...
*
* Apply the colon syntax for the Circle class constructors
*
* @file Circle.cpp
* @author Chunyu Yuan
* @version 1.4 02/13/2021
*
*/
...
namespace Chunyu   // own namespace Chunyu
{
	...
	namespace CAD
	{
		...
		Circle::Circle(const Point& newCentreP, const double& newRadius):centrePoint(newCentreP), m_radius(newRadius)
		{
		...
		Circle::Circle(const Circle& circle):centrePoint(circle.centrePoint), m_radius(circle.m_radius)
		{
