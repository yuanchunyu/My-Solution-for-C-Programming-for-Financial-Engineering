/*
* Level_3 Exercise 2.3.1:
* Test program for Points in two dimensions
* Add copy constructor and do constructor experiments
*
...
int main()
{
	...
	Point point(x, y); //create another Point object point1 with x1 and y1
	...
	/*
	* Before adding copy contructor, I see 2 times contructors are called and 3 times destructor called
	* 
	* After adding copy contructor, I see 3 times contructors are called include one copy constructor is called and 3 times destructor called, 
	* and the number of constructors are called now  the same as the number of destructor calls
	* 	
	*/
