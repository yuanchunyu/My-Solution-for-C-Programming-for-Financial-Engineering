...
*
* adding a << operator function that has on the left an std::ostream and on the right the point object
*
* @file Point.hpp
* @author Chunyu Yuan
* @version 1.8 02/13/2021 
*
*/
...
{
	os << p.ToString() ; //get point description string to the os argument
