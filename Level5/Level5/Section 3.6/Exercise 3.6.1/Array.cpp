...
*
* Change the Array class to throw exceptions in the GetElement(), SetElement() and index operator
*
* @file Array.cpp
* @author Chunyu Yuan
...
namespace Chunyu // own namespace Chunyu
{
	namespace Containers //Containers namespace 
	{
		...
		const CAD::Point& Array::GetElement(int index)const
		{
			...
			{
				throw - 1;  //the index is out of bounds, throw -1
			}
		}
